        ...
        public async Task SeedAsync()
        {
            ...
            if (! _db.Characters.Any())
            {
                var characters = new[]
                {
                    ...
                    new CharacterEntity { Id = 4, Name = "Faisal", ImageUrl = "public/Faisal.png", MaxHealth = 52, CurrentHealth = 52, Attack = 3, Defense = 8, TechAttack = 4, TechDefense = 8 },
                    ...
                    new CharacterEntity { Id = 9, Name = "Sam", ImageUrl = "public/Sam.png", MaxHealth = 43, CurrentHealth = 43, Attack = 12, Defense = 7, TechAttack = 5, TechDefense = 4 },
                    ...
                    new CharacterEntity { Id = 11, Name = "Paul", ImageUrl = "public/Paul2.png", MaxHealth = 38, CurrentHealth = 38, Attack = 8, Defense = 8, TechAttack = 12, TechDefense = 7 },
