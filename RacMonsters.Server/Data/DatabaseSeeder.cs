        ...
        public async Task SeedAsync()
        {
            ...
            if (! _db.Abilities.Any())
            {
                var abilities = new[]
                {
                    ...
                    new AbilityEntity { Id = 9, Name = "Home DIY", Description = "Forces you to assist with DIY causing an accident with a saw", IsTech = false, IsHeal = false, Power = 6, Speed = 8, Accuracy = 0.95 },
                    new AbilityEntity { Id = 10, Name = "Hyrox", Description = "Join a hyrox session leaving you delapadated", IsTech = false, IsHeal = false, Power = 9, Speed = 4, Accuracy = 0.8 },
                    ...
                    new AbilityEntity { Id = 12, Name = "New FE Package", Description = "Preaches about a new FE Package derailing your workflow", IsTech = true, IsHeal = false, Power = 9, Speed = 2, Accuracy = 0.65 },
                    ...
                    new AbilityEntity { Id = 29, Name = "Datalake", Description = "Drown the user in data so they cant breathe", IsTech = true, IsHeal = false, Power = 11, Speed = 3, Accuracy = 0.7 },
                    ...
                    new AbilityEntity { Id = 31, Name = "Snowflake", Description = "Throws a snowflake data query at you at lighting speed", IsTech = true, IsHeal = false, Power = 8, Speed = 9, Accuracy = 0.9 },
                    ...
                    new AbilityEntity { Id = 53, Name = "Roundhouse Kick", Description = "Delivers a powerful roundhouse kick", IsTech = false, IsHeal = false, Power = 11, Speed = 6, Accuracy = 0.75 },
                    ...
                    new AbilityEntity { Id = 56, Name = "Transcribe Hell", Description = "Pulls up a log where you said something inappropriate causing you to visit HR", IsTech = true, IsHeal = false, Power = 12, Speed = 4, Accuracy = 0.65 },
